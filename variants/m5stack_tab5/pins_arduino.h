/* Copied from espressif/arduino-esp32 variants/m5stack_tab5 (retail M5Stack Tab5).
 * The pioarduino framework package may only ship `esp32p4` = P4 Function EV board pins. */
